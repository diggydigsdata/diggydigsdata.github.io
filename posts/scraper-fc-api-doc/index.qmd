...
_Copyright 2022 Owen Seymour. Use of this source code is governed by the GPL 3.0 license._
...
`scrape_stats()` allows you to download FBref season-level _Squad Stats_, _Opponent Stats_, and _Player Stats_ for a chosen statistics collection such as "Advanced Goalkeeping".

You can reference the available statistics collections by accessing:  
...
- **year** (str, required)
  - Season to scrape.
  - Format: match the season strings on the _Competition History_ page of the target league (e.g., [Big 5 Leagues](https://fbref.com/en/comps/Big5/history/Big-5-European-Leagues-Seasons)).
...
- https://scraperfc.readthedocs.io/en/latest/
